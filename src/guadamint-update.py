...
import shutil
import random
import filecmp  # NECESARIO PARA COMPARAR ARCHIVOS
...
# ==============================================================================
# SISTEMA DE AUTO-ACTUALIZACIÓN (GIT + INTEGRIDAD)
# ==============================================================================
...
def auto_actualizar_desde_git():
    ...
    if not os.path.exists(REPO_DIR):
        ...
        try:
            ...
            # Forzamos fetch de la rama específica
            ...
            if local_hash != remote_hash:
                ...
                # NIVEL 2: Comprobación de Integridad (El archivo instalado vs El del repo)
                # Si Git está al día, pero el archivo en /usr/bin es distinto al de /opt, actualizamos.
                if os.path.exists(SCRIPT_SRC_PATH):
    ...
    # 3. Aplicar cambios y reencarnar
    if se_requiere_reinicio:
        ...
        try:
            if os.path.exists(SCRIPT_SRC_PATH):
                ...
                # Pequeña pausa para asegurar que el disco escribe
                time.sleep(1)
                
                log_y_print(">>> ¡REINICIO EN CURSO! (El script volverá a empezar)")
